document.addEventListener("DOMContentLoaded", () => {
    ...
    function setDynamicDefaults() {
        ...
        ui.startDateInput.value = '2004-01-01'; // More practical default
    }
    ...
    function calculateMonteCarloProjection(portfolioResult, params) {
        const { simulations, accumulationYears, decumulationYears, initialContribution, contributionIncrease, withdrawalStrategy, withdrawalRate, withdrawalAmount, inflationRate, goal } = params;
    ...
    function logToPage(message, isError = false, container) {
        ...
        const content = container.querySelector('h4') ? container : container;
    ...
    async function runBacktest() {
        ...
        try {
            ...
            appState.backtestConfig.effectiveStartDate = effectiveStartDate; // Store for later use
